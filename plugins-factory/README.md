...
├── hooks/ + bin/  9 stdlib gates + an advisory hook    → mechanized structure + liveness + recall + bake-safety + trust-boundary + context-cost
