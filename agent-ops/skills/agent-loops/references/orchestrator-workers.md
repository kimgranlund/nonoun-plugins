...
| **Non-termination** — orchestrator researches past sufficiency, or workers chase nonexistent sources, with no hard stop | Layered termination (hard caps + guardrails), not sufficiency-self-judgment alone | OW6 |
