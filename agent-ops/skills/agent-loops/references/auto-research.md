...
- **The total information to gather exceeds a single context window** — parallel subagents each get a fresh window, multiplying effective context. Willison: _"The key benefit is all about managing that 200,000 token context limit."_
