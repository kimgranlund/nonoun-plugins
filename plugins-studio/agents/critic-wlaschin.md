...
description: >
  Plugins-studio council critic — Scott W.. Manifest correctness, making illegal layout/state unrepresentable, and cross-plugin path legality. Invoked by the plugin-council orchestrator to adversarially review a plugin.
---
