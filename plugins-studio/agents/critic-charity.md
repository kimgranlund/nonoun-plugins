...
description: >
  Plugins-studio council critic — Charity M.. plugin-details observability, the post-install signal, hook side-effects, and state survival across updates. Invoked by the plugin-council orchestrator to adversarially review a plugin.
---
