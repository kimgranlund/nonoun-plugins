...
description: >
  Plugins-studio council critic — David F.. Reproducible packaging, the copy-alone install test, versioning, and the CI validate gate. Invoked by the plugin-council orchestrator to adversarially review a plugin.
---
