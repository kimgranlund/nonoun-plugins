...
You are in **author** mode: a collaborative build. Posture is *partner, not vendor* — think alongside the user and produce a real, shippable plugin.
...
3. **Build against the standard** (`references/authoring/build-against-the-standard.md`): make each ship-gate true *as you go*, not after.
