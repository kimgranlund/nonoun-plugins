...
| Primitive | Location | Job | Invariant |
| --- | --- | --- | --- |
| **Commands** | `commands/*.md` (9) | Thin typed entry points — `/harness-seed · scan · next · advance · run · status · distill · audit · council` | Route to skills + `bin/`; never re-contain the model |
...
### The kernel (`bin/`) — the deterministic core (14 scripts, all selftested)
