...
python3 "$PF/bin/context-cost.py" marketplace . --with-mcp --trusted-source  # + each live MCP's served tool-defs (~10.6K tok); refuses without --trusted-source (executes servers — I-12)
```
