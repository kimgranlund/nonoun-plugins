...
description: >-
  ...
  search, filtering). The MAKER skill for structure, grounded in Garrett, Covert, Rosenfeld–Morville–Arango,
  Prater, Norman, Shneiderman. Triggers: "design the navigation / IA", "what's the object model", "map the
