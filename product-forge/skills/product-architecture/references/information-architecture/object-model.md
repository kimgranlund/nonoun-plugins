...
- **Cluster synonyms, split homonyms.** "Customer" and "client" referring to one thing collapse into one object; "report" used for both a document and an action splits — the document is an object, the action is a CTA. (This is Covert's ontology work, done with a highlighter.)
