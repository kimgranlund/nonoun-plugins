...
This is the table of contents for the product-pattern library — the categorized index behind the library's "and many more." Patterns are organized into **seven categories**: **flows** (multi-step journeys), **interaction** (single-surface behaviours), **content** (how information is presented), **feedback** (how the system tells the user what happened), **monetization** (commerce and conversion, including the deceptive line), **substrate** (the cross-cutting floor every pattern sits on), and **ai-ux** (patterns specific to generative / agentic interfaces). Each entry is a one-line scope plus, where one applies, the cognitive law it leans on (→ see the laws-of-ux reference) or the NN/g guidance it tracks. Patterns with their own deep-dive references in this library are noted; the rest are scoped here and expanded on demand. This index is the authoritative roster — when a critique asks "what patterns apply to this surface?", start here.
